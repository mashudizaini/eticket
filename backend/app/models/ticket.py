...
class Ticket(Base):
    ...
    requester_fullname = Column(String(200))  # last_name from Oracle per_people_f
    team_id = Column(String(50))  # Oracle PER_ALL_ASSIGNMENTS_F.ass_attribute30
    team_desc = Column(String(200))  # Oracle fnd_flex_values_vl.description
    pic_id = Column(Integer)  # Oracle person_id, no FK constraint
    pic_name = Column(String(100))
    pic_fullname = Column(String(200))  # last_name from Oracle per_people_f
